...
public abstract class BaseAssesCategory  implements Serializable {

	// constructors
	public BaseAssesCategory () {
		initialize();
	}
	 ...
	 */
	public BaseAssesCategory (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	private java.util.Set<AssesType> types;
	...
	public java.util.Set<AssesType> getTypes() {
		return types;
	}

	public void setTypes(java.util.Set<AssesType> types) {
		this.types = types;
	}
